...
class EditCategoryImageDialog extends StatelessWidget {
  const EditCategoryImageDialog({super.key, required this.categoryId});
  final int categoryId;
  @override
  Widget build(BuildContext context) {
    return AlertDialog(
        title: Text('Edit Category Image', style: TextStyles.headline2),
        content: Column(
