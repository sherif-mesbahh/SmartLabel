...
internal sealed class GetAllCategoriesPaginatedHandler(ICategoryProcRepository categoryProcRepository)
	: ResponseHandler, IRequestHandler<GetAllCategoriesPaginatedQuery, PagedList<GetAllCategoriesDto>>
{
		...
		CancellationToken cancellationToken)
	{
		...
		var categories = PagedList<GetAllCategoriesDto>.CreateAsync(cat, totalCount, page, pageSize);
